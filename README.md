...
My apologies! You are absolutely right. I misunderstood your request for "com as TAGs e marcações" and didn't provide the raw Markdown text directly.

Here is the complete README with all the Markdown formatting already applied, ready for you to copy and paste directly into a .md file on GitHub.
...
4.  **Crie o Arquivo de Variáveis de Ambiente (`.env`):**
    ...
    # Nome do modelo LLM carregado no LM Studio.
    # AJUSTE ESTE VALOR para o nome EXATO do modelo que você carregou.
    # Ex: bartowski/llama-3.2-1b-instruct, bartowski/llama-3.2-1b-instruct, etc.
    # Você pode encontrar este nome na aba 'Local Inference Server' do LM Studio.
    LLM_MODEL_NAME=bartowski/llama-3.2-1b-instruct 
    ```
